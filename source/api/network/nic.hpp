...
public:
    ...
    void handle_receive() {
        ...
        while (true) {
            ...
            if (bytes_received <= 0) {
                // If we get EWOULDBLOCK or no data, the kernel buffer is empty.
                break; 
            }
            ...
            //std::cout << "Is raw socket engine? " << (is_raw_socket_engine ? "Yes" : "No") << std::endl;
            ...
            // should be optimized at #43 using buffer pools
